...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/MADISON1100/DANIEL/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1208165035, 1744308503,1903062491,1058949070,30,1895938505}   
...
var = true
elseif tonumber(user_id) == tonumber(1903062491) then
var = true
elseif tonumber(user_id) == tonumber(30) then
var = true
elseif tonumber(user_id) == tonumber(1895938505) then
var = true
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 𝐒𝐎𝐔𝐑𝐂𝐄 𝐃𝐀𝐍𝐈𝐄𝐋")  
...
os.execute('wget https://raw.githubusercontent.com/MADISON1100/DANIEL/main/DRAGON.lua')
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "دانيال")
...
os.execute('rm -rf DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/MADISON1100/DANIEL/main/DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/MADISON1100/DANIEL/main/library')
os.execute('wget https://raw.githubusercontent.com/MADISON1100/DANIEL/main/File_Bot')
send(msg.chat_id_, msg.id_,' ◉ تم تحديث السورس')
dofile('DRAGON.lua')  
end
...
[♢ | 𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐓𝐨 𝐒𝐨𝐮𝐫𝐜𝐞 𝐃𝐚𝐧𝐢𝐞𝐥](t.me/ELKAEEB1)

[♢ | 𝐃𝐚𝐧𝐢𝐞𝐥 𝐓𝐡𝐞 𝐁𝐞𝐬𝐭 𝐒𝐨𝐮𝐫𝐜𝐞 𝐎𝐧 𝐓𝐞𝐥𝐞](t.me/ELKAEEB1)

[♢ | 𝐅𝐨𝐥𝐥𝐨𝐰 𝐓𝐡𝐞 𝐁𝐮𝐭𝐭𝐨𝐧𝐬 𝐁𝐞𝐥𝐨𝐰](t.me/ELKAEEB1)
...
{{text = '℡ ᯓ 𓌹 𝐃𝐀𝐍𝐈𝐄𝐋 𓌺 ˹',url="t.me/Dad_Daniel"},{text = '℡ ᯓ 𓌹 𝐆𝐈𝐊𝐀 𓌺 ˹',url="t.me/SUL_A_Q"},},
	
{{text = '℡ ᯓ 𓌹 𝐌𝐀𝐃𝐈𝐒𝐎𝐍 𓌺 ˹ ',url="t.me/AAHMEED11"}},
...
https.request("https://api.telegram.org/bot"..token..'/sendanimation?chat_id=' .. msg.chat_id_ .. '&animation=https://t.me/MADI_PICK/29&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '℡ ᯓ 𓌹 𝐃𝐀?? 𝐃??𝐍𝐈𝐄𝐋 𓌺 ˹', url="t.me/Dad_Daniel"}}, 
{{text = '𓆩⌯𝐒𝐎𝐔𝐑𝐂𝐄 𝐃𝐀𝐍𝐈𝐄𝐋⌯𓆪', url="t.me/Dad_Daniel"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/MADI_PICK/29&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local Text = [[ 
◉ للتواصل مع مبرمجين سورس دانيال ♡
◉ اتبع الازرار الاتيه ↑↓
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
...
{{text = '℡ ᯓ 𓌹 𝐃𝐀𝐍𝐈𝐄𝐋 𓌺 ˹',url="t.me/Dad_Daniel"},{text = '℡ ᯓ 𓌹 𝐆𝐈𝐊𝐀 𓌺 ˹',url="t.me/SUL_A_Q"},},
{{text = '℡ ᯓ 𓌹 𝐌𝐀𝐃𝐈𝐒𝐎𝐍 𓌺 ˹ ',url="t.me/AAHMEED11"}},
{{text = 'لـو مـحـظـور ♡',url="t.me/ELKAEEB7_bot"}},
{{text = '𓆩⌯𝐒𝐎𝐔𝐑𝐂𝐄 𝐃𝐀𝐍𝐈𝐄𝐋⌯𓆪', url="t.me/Dad_Daniel"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/MADI_PICK/29&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
...
local Name = 'للتواصل مع المبرمج ماديسون اتبع الازرار ♡\n['..result.first_name_..'](t.me/AAHMEED11)\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '  ❨  '..result.first_name_..'  ❩ ',url="t.me/"..result.username_},
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = 'للتواصل مع المبرمج كمال اتبع الازرار ♡\n['..result.first_name_..'](t.me/W_H_U)\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '  ❨  '..result.first_name_..'  ❩ ',url="t.me/"..result.username_},
...
if text == "السلطان"  then
local TEXT_SUD = database:get(bot_id..'Tshake:TEXT_SUDO')
if TEXT_SUDO then 
send(msg.chat_id_, msg.id_,TEXT_SUDO)
else
tdcli_function ({ID = "GetUser",user_id_ =  1903062491,},function(arg,result) 
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = 'للتواصل مع السلطان مطور السورس اتبع الازرار ♡\n['..result.first_name_..'](t.me/SUL_A_Q)\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '  ❨  '..result.first_name_..'  ❩ ',url="t.me/"..result.username_},
...
tdcli_function ({ ID = "GetUserProfilePhotos", user_id_ =  1903062491, offset_ = 0, limit_ = 1 }, taha, nil)
end,nil)
end
end
...
tdcli_function ({ID = "GetUser",user_id_ =  1058949070,},function(arg,result) 
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = 'للتواصل مع دانيال مبرمج السورس اتبع الازرار ♡\n['..result.first_name_..'](t.me/Dad_Daniel)\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '  ❨  '..result.first_name_..'  ❩ ',url="t.me/"..result.username_},
...
tdcli_function ({ ID = "GetUserProfilePhotos", user_id_ =  1058949070, offset_ = 0, limit_ = 1 }, taha, nil)
end,nil)
end
end
...
{
{text = 'قـنـاة الـتـحـديـثـآت', url = "https://t.me/ELKAEEB1"},
},
}
local msg_id = msg.id_/2097152/0.5
...
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
◉ 𝘾𝙃 - [𝐒𝐎𝐔𝐑𝐂𝐄 𝐃𝐀𝐍𝐈𝐄𝐋](t.me/ELKAEEB1 ) 
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
]]
keyboard = {}  
keyboard.inline_keyboard = { 
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/MADI_PICK/29?single&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
elseif text == 'قفل دانيالرسيه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
...
elseif text == 'فتح دانيالرسيه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
...
if tonumber(result.sender_user_id_) == tonumber(1895938505) then  
...
if tonumber(result.sender_user_id_) == tonumber(1903062491) then  
send(msg.chat_id_, msg.id_, "◉ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if result.id_ == tonumber(1895938505) then
send(msg.chat_id_, msg.id_, "◉ لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
if tonumber(userid) == tonumber(1895938505) then  
send(msg.chat_id_, msg.id_, "◉ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if tonumber(userid) == tonumber(1903062491) then  
send(msg.chat_id_, msg.id_, "◉ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if result.id_ == tonumber(1903062491) then
send(msg.chat_id_, msg.id_, "◉ لا يمكنك كتم مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(30) then
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/MADISON1100/DANIEL/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/MADISON1100/DANIEL/main/File_Bot/"..file)
if res == 200 then
...
send(msg.chat_id_, msg.id_, t..'✪❯─────「𝐃𝐀𝐍𝐈𝐄𝐋」─────❮✪\nاضغط علي الاسم ليتم نسخه\n✪❯─────「𝐃𝐀𝐍𝐈𝐄𝐋」─────❮✪ٴ\n ◉ ❲[『𝙰𝚕𝚏𝚊』](t.me/ELKAEEB1 )❳ ◉ ')
end
...
{
{text = 'قفل دانيالرسيه ◉', callback_data=data.sender_user_id_.."/lockfarse"},{text = 'فتح دانيالرسيه ◉', callback_data=data.sender_user_id_.."/unlockfarse"},
},
{
...
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
◉ 𝘾𝙃 - [𝐒𝐎𝐔??𝐂𝐄 𝐃𝐀𝐍𝐈𝐄𝐋](t.me/ELKAEEB1 ) 
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
]]
keyboard = {} 
keyboard.inline_keyboard = {
